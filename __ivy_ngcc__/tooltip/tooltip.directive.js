...
TooltipDirective.ɵfac = function TooltipDirective_Factory(t) { return new (t || TooltipDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ComponentLoaderFactory), ɵngcc0.ɵɵdirectiveInject(TooltipConfig)); };
TooltipDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TooltipDirective, selectors: [["", "tooltip", ""], ["", "tooltipHtml", ""]], inputs: { _animation: ["tooltipAnimation", "_animation"], _delay: ["tooltipPopupDelay", "_delay"], _fadeDuration: ["tooltipFadeDuration", "_fadeDuration"], isOpen: "isOpen", htmlContent: ["tooltipHtml", "htmlContent"], _placement: ["tooltipPlacement", "_placement"], _isOpen: ["tooltipIsOpen", "_isOpen"], _enable: ["tooltipEnable", "_enable"], _appendToBody: ["tooltipAppendToBody", "_appendToBody"], _popupClass: ["tooltipClass", "_popupClass"], _tooltipContext: ["tooltipContext", "_tooltipContext"], _tooltipTrigger: ["tooltipTrigger", "_tooltipTrigger"], tooltip: "tooltip", placement: "placement", triggers: "triggers", container: "container", isDisabled: "isDisabled" }, outputs: { tooltipChange: "tooltipChange", tooltipStateChanged: "tooltipStateChanged", onShown: "onShown", onHidden: "onHidden" }, exportAs: ["bs-tooltip"] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TooltipDirective, [{
    ...
    }], function () { return [{ type: ɵngcc0.ViewContainerRef }, { type: Renderer }, { type: ɵngcc0.ElementRef }, { type: ComponentLoaderFactory }, { type: TooltipConfig }]; }, { tooltipChange: [{
            type: Output
        }], _animation: [{
            type: Input,
